...
本 repo 提供這個轉變背後的**架構原則**、**結構化的學習路徑**，以及**即用 Skills** 讓你立即體驗。
...
Content is licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). Code is licensed under [MIT](LICENSE).

內容以 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 授權。程式碼以 [MIT](LICENSE) 授權。
